#include "../include/NFO.hpp"
#include "RoboticArmProblemDescription.hpp"
#include <eigen3/Eigen/Dense>
#include <iostream>

int main() {
    RoboticArmProblemDescription problem;
    NFO functionOptim(&problem, 3, 2, 0);
    ...
    Eigen::Vector<double,3> initialCond{0.785,0.785,0.785};
